...
public class ClientRequestException extends RuntimeException {
    ...
    // 带异常根源的构造方法
    public ClientRequestException(int code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
        this.message = message;
        this.cause = cause;
    ...
    // 快速构建方法（带默认错误码）
    public static ClientRequestException of(String message) {
        return new ClientRequestException(500, message);
    }
